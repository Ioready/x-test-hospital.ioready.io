...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="editFormAjax" method="post" action="<?php echo base_url('index.php/faq/faq_update') ?>" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <textarea type="text" class="form-control ckeditor summernote" name="answer" id="answer"><?php echo $results->answer; ?></textarea>
