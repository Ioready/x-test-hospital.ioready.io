...
<div id="page-content">
    ...
    <div class="block full">
        ...
        <form class="form-horizontal" role="form" id="editFormAjaxUser" method="post" action="<?php echo base_url('setting/updateConsultation') ?>" enctype="multipart/form-data">
                                ...
                                <div class="col-md-8">
                                    <div class="col-md-12">
                                        ...
                                        <?php if($list->question != null){ ?>
                                            <div style="font-weight: 600;font-size: large;" id="addQuestion">
