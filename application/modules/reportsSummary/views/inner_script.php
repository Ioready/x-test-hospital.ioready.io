...
<script>
    ...
    function getAntibioticByCareUnitFacilitydays(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx, date_of_start_abx1, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_facility_days";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getAntibioticByCareUnitFacilitydaysaverage(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var steward = $("#steward").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_facility_days_average";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getProviderStewardAgreementdays(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var steward = $("#steward").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_provider_steward_agreement_days";
        $.ajax({
            method: "POST",
            url: url,
            data: {
            ...
            success: function(response) {
                if (response.status == 200) {
                    ...
                    var stewardScores = [];
                    var providerScores = [];
                    // console.log('kkk', response.antibiotic);
                    response.antibiotic.forEach(element => {
                        // response.antibiotic.slice(0,10).forEach(element => {
                        // console.log('agree', element.agree);
                        // console.log('modify', element.NoResponse);
                        // console.log('disagree', element.disagree);
                        // console.log('Neutral', element.Neutral);

                        var agree = element.agree !== null ? element.agree * 1 : 0;
                        var modify = element.NoResponse !== null ? element.NoResponse * 0.5 : 0;
                        var disagree = element.disagree !== null ? element.disagree * (-1) : 0;
                        var neutral = element.Neutral !== null ? element.Neutral * 0 : 0;
                        var agreest = element.agree || 0;
                        var modifyst = element.NoResponse || 0;
                        var disagreest = element.disagree || 0;
                        // var neutralst = (element.Neutral) || 0;
                        var agreest = parseFloat(agreest); // Convert to a floating-point number
                        var modifyst = parseFloat(modifyst); // Convert to a floating-point number
                        var disagreest = parseFloat(disagreest);

                        var totalPoints = (agree + modify + disagree + neutral).toFixed(2);

                        // console.log('totalPoints', totalPoints);
                        var stewardPoints = ((agreest + modifyst + disagreest).toFixed(2));
                        // console.log('stewardPoints', stewardPoints);

                        var stewardScore = 1;
                        var providerScore = stewardPoints !== 0 ? ((totalPoints / stewardPoints).toFixed(2)) : 0.00;
                        // Check if stewardPoints is not zero
                        // providerScore = parseFloat((providerScore).toFixed(2));
                        // console.log('element', element);
                        // console.log('providerScore', providerScore);

                        ChartGraphName.push(element.name);
                        stewardScores.push(stewardScore);
                ...
                if (response.status == 200) {
                    ...
                    let chat50Data = response.antibiotic;
                    chat50Data.forEach(element => {
                        ChartGraphName.push([element.name]);
                        backgroundColors.push([element.backgroundColor]);
                    ...
                    $('#canvas50').remove(); // this is my <canvas> element
                    $('#Graph-chart50').append('<canvas id="canvas50"><canvas>');
                    var ctx = document.getElementById("canvas50");
                    var data = {
                        labels: ChartGraphName,
                        datasets: [{
                                label: "Agree",
                        ...
                        options: {
                            ...
                            scales: {
                                ...
                                yAxes: [{
                                    ...
                                    scaleLabel: {
                                        display: true,
                                        labelString: 'Count of Agree / Disagree / Neutral / Modify' /* 'Total No.of Provider Steward Agreement' */
                                    },
                                    ticks: {
                                        min: 0,
                                    }
    ...
    function getAntibioticByCareUnitFacility(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var steward = $("#steward").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_facility";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getAntibioticByCareUnitProvider(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx, date_of_start_abx1, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_provider";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getAntibioticByCareUnitProvideraverage( /* careUnit, */ rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx, date_of_start_abx1, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_provider_average";
        $.ajax({
            method: "POST",
            url: url,
            data: {
 ...
 */
    ...
    function getAntibioticByCareUnitProviderPie(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_provider_pie";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function get_dx_by_actual_dots(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx, date_of_start_abx1, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_dx_by_actual_dots_new";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function get_avg_dx_by_actual_dots(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_avg_dx_by_actual_dots_new";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function total_abx_days(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx, date_of_start_abx1, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/total_abx_days";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function total_abx_days_dollar(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/total_abx_days_dollar";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getDaysByProvideANDStewardNew(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_days_provider_and_steward";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function get_days_cost(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_days_cost";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function get_days_costsavedbysteward(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_days_costsavedbysteward";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function get_cost_cost(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_cost_cost";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getDaysByProvideANDStewardNewinitialandactual(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_days_provider_and_steward_new";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getDaysByProvideANDStewardNewinitialandactualcost(careUnit, rx, date1, date2, symptom_onset, criteria_met, md_stayward_response, culture_source, date_of_start_abx2, date_of_start_abx3, organism, precautions) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_days_provider_and_steward_cost";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getAntibioticByCareUnitSteward(careUnit, rx) {
        ...
        var RX = $("#RX").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_md_steward";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getDaysSavedByCareUnit(careUnit, rx) {
        //var careUnit = $("#careUnit").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_days_saved_by_care_unit";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function actual_dot_vs_new_dot_by_care_unit(careUnit, rx) {
        //var careUnit = $("#careUnit").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/actual_dot_vs_new_dot_by_care_unit";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function actual_dot_vs_new_dot_by_care_unit_md_steward(careUnit, rx) {
        //var careUnit = $("#careUnit").val();
        var steward = $("#steward").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/actual_dot_vs_new_dot_by_care_unit_md_steward";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function actual_dot_vs_new_dot_by_care_unit_provider_doctor(careUnit, rx) {
        //var careUnit = $("#careUnit").val();
        var provider_doctor = $("#provider_doctor").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/actual_dot_vs_new_dot_by_care_unit_provider_doctor";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function get_rx_by_actual_dots(careUnit, rx) {
        var careUnit1 = $("#careUnit").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_rx_by_actual_dots";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function downloadPDF49(id, name) {
        ...
        doc.text(120, 10, 'Steward Agreement');
        doc.addImage(canvasImg, 'png', 10, 10, 280, 160);
        doc.save(name + '.pdf');
    }
    ...
    function getAntibioticByCareUnitProviderId() {
        ...
        var careUnit = $("#careUnit").val();
        var rx = $("#RX").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_provider_id";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getAntibioticByCareUnitProviderPrice(careUnit, provider, rx) {
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_provider_price";
        $.ajax({
            method: "POST",
            url: url,
            data: {
    ...
    function getAntibioticByCareUnitStewardPrice(careUnit, provider, rx) {
        ...
        var rx = $("#RX").val();
        var url = "<?php echo base_url() ?>index.php/reportsSummary/get_antibiotic_by_care_unit_steward_price";
        $.ajax({
            method: "POST",
            url: url,
            data: {
