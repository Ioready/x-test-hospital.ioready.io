                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                    <textarea name="details" id="body" rows="40" cols="40"><?php echo htmlspecialchars($result->details); ?></textarea>

                                    <!-- <textarea name="details" id="body" rows="20" cols="30"><?php echo $result->details?></textarea>
                                         -->
                                    </div>
                                </div>
