...
<!-- <form class="form-horizontal" role="form" id="addFormAjax" method="post" action="<?php echo base_url($formUrlData) ?>" enctype="multipart/form-data"> -->
        <form class="form-horizontal" role="form" id="" method="post" action="<?php echo base_url();?>LettersAndForm/addBookingForm">
            ...
            <input type="text" name="patient_id" id="patient_id" value="307">
               
                <div class="col-md-4 mb-3">
                    <label for="name" class="form-label">1. Appointment Type</label>

                        <div class="custom-control custom-checkbox">
                            <input type="radio" class="custom-control-input" id="appointment_type" name="appointment_type" value="Medical admission">
                            <label class="custom-control-label" for="appointment_type">Medical admission</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="radio" class="custom-control-input" id="appointment_type" value="Surgical admission" name="amSnack">
                            <label class="custom-control-label" for="appointment_type" >Surgical admission</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="radio" class="custom-control-input" id="appointment_type" value="Re-admission"  name="appointment_type">
            ...
            <!-- <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="empi_number" id="empi_number" placeholder="Enter your EMPI number" required>
                </div>
