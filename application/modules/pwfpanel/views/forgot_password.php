    ...
    <!--            <img src="<?php echo base_url(); ?>backend_asset/admin/img/placeholders/headers/login_header.png" alt="Login Background" class="animation-pulseSlow">-->
            ...
            <div id="login-container" class="animation-fadeIn">
                ...
                <div class="block push-bit bg_color_login">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="email" id="identity" name="identity" class="form-control input-lg" placeholder="Email">
                            </div>
                        </div>
                    </div>
                    ...
                    <!--                     <div class="col-xs-12">
                                                <div class="forget_pass forgot_text_pass"><a href="<?php echo site_url('pwfpanel/login') ?>">Login</a></div>
                                            </div> -->
                    <div class="clear"></div>
                    <h3>  <div class="forget_pass forgot_text_pass"><a href="<?php echo site_url('pwfpanel/login') ?>">Login</a></div></h3>
                    <?php echo form_close(); ?>
                </div>
