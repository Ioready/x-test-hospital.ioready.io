                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select id="md_stayward_consult" name="md_stayward_consult" class="form-control select-chosen" size="1">
                                            <option value="" >Please select</option>
                                            <option value="Yes" <?php //echo ($results->md_stayward_consult == "Yes") ? "selected" : ""; 
                                                                ?>>Yes</option>
                                            <option value="No" <?php //echo ($results->md_stayward_consult == "No") ? "selected" : ""; 
                                                                ?>>No</option>
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-9">
                                            <select id="additional_comment_option" name="additional_comment_option[]" onchange="isDirty(this.value)" class="form-control multiple-select select-chosen" size="1" multiple="multiple">
                                                ...
                                                <!--  <option value="" disabled>Please select</option> 
                                                    <option value="Antibiotics not recommended"<?php if ($results->additional_comment_option == 'Antibiotics not recommended') {
                                                                                                    echo "selected";
                                                                                                } ?> >Antibiotics not recommended</option>

                                                    <option value="Re-evaluate need for antibiotics in 48 hours" <?php if ($results->additional_comment_option == 'Re-evaluate need for antibiotics in 48 hours') {
                                                                                                                        echo "selected";
                                                                                                                    } ?> >Re-evaluate need for antibiotics in 48 hours</option>
                                                    <option value="Target for de-escalation" <?php if ($results->additional_comment_option == 'Target for de-escalation') {
                                                                                                    echo "selected";
                                                                                                } ?> >Target for de-escalation</option>
                                                    <option value="Antibiotic checklist not present" <?php if ($results->additional_comment_option == 'Antibiotic checklist not present') {
                                                                                                            echo "selected";
                                                                                                        } ?> >Antibiotic checklist not present</option>
                                                    <option value="Other/free text" <?php if ($results->additional_comment_option == 'Other/free text') {
                                                                                        echo "selected";
