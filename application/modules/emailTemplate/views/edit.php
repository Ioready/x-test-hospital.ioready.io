...
<div id="commonModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="editFormAjax" method="post" action="<?php echo base_url('emailTemplate/template_update') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12" >
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="email_type" class="form-control" value="<?php echo $results->email_type; ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                   <label class="col-md-3 control-label"><?php echo lang('description');?></label>
                                    <div class="col-md-9">
                                        <textarea class="form-control ckeditor" name="description" id="description"><?php echo $results->description;?></textarea>
                                    </div>
                                     <span class="help-block m-b-none col-md-offset-3">
                                </div>
                            </div>
                                              ...
                                              <span class="glyphicon input_img2 logo_btn" style="display: block;">
                                                ...
                                                <span class="ceo_logo">
                                                    <?php if(!empty($results->image)){ ?>
                                                        <img src="<?php echo base_url().'uploads/emailTemplate/'.$results->image;?>">
                                                    <?php }else{ ?>
