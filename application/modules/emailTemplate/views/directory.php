    ...
    <div class="">  
        <div class="row">
            ...
            <div class="col-md-3 mt-4">
                <a href="<?php echo site_url('emailTemplate/header'); ?>" class="<?php echo (strtolower($this->router->fetch_class()) == "directory") ? "active" : "" ?>"><span class="sidebar-nav-mini-hide">
...
<div class="block full">
    ...
    <div class="">  
        <div class="row">
            ...
            <div class="col-md-3 mt-4">
                <a href="<?php echo site_url('emailTemplate/bodies'); ?>" class="<?php echo (strtolower($this->router->fetch_class()) == "directory") ? "active" : "" ?>"><span class="sidebar-nav-mini-hide">
    ...
    <div class="">  
        <div class="row">
            ...
            <div class="col-md-4 mt-4">
                <a href="<?php echo site_url('emailTemplate/recipients'); ?>" class="<?php echo (strtolower($this->router->fetch_class()) == "directory") ? "active" : "" ?>"><span class="sidebar-nav-mini-hide">
...
<div class="block full">
    ...
    <div class="">  
        <div class="row">
            ...
            <div class="col-md-3 mt-4">
                <a href="<?php echo site_url('emailTemplate/footer'); ?>" class="<?php echo (strtolower($this->router->fetch_class()) == "directory") ? "active" : "" ?>"><span class="sidebar-nav-mini-hide">
