...
<script src="<?php echo base_url(); ?>backend_asset/plugins/summernote/dist/summernote.min.js"></script>
<script>
 App.datatables();
 ...
 $('#common_datatable_cmss').dataTable({
      order: [],
...
jQuery('body').on('click', '.button_close', function () {
 // $("").click(function(){
   $("#custommodel").addClass("open_custom")
